...
def register_view(request):
    if request.user.is_authenticated:
        messages.success(request, "شما قبلاً وارد شده‌اید")
        return redirect("/")
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request, "احراز هویت ناموفق بود، لطفاً دوباره تلاش کنید!")
        ...
        if form.is_valid():
            ...
            try:
                ...
                if user_instance is not None:
                    ...
                    messages.error(request, "نام کاربری یا رمز عبور وجود ندارد!")
            except:
