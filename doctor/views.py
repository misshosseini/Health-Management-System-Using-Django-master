...
def activate_appointment(request, appointment_id):
    ...
    appointment.status = "برنامه‌ریزی شده"
    appointment.save()

    messages.success(request, "نوبت با موفقیت برنامه‌ریزی مجدد شد")
    return redirect("doctor:appointment_detail", appointment.appointment_id)
...
def complete_appointment(request, appointment_id):
    ...
    messages.success(request, "نوبت با موفقیت تکمیل شد")
    return redirect("doctor:appointment_detail", appointment.appointment_id)
...
def add_medical_report(request, appointment_id):
    ...
    messages.success(request, "گزارش پزشکی با موفقیت اضافه شد")
    return redirect("doctor:appointment_detail", appointment.appointment_id)
...
def edit_medical_report(request, appointment_id, medical_report_id):
    ...
    messages.success(request, "گزارش پزشکی با موفقیت به‌روزرسانی شد")
    return redirect("doctor:appointment_detail", appointment.appointment_id)
...
def add_lab_test(request, appointment_id):
    ...
    messages.success(request, "گزارش آزمایشگاه با موفقیت اضافه شد")
    return redirect("doctor:appointment_detail", appointment.appointment_id)
...
def edit_lab_test(request, appointment_id, lab_test_id):
    ...
    messages.success(request, "گزارش آزمایشگاه با موفقیت به‌روزرسانی شد")
    return redirect("doctor:appointment_detail", appointment.appointment_id)
...
def add_prescription(request, appointment_id):
    ...
    messages.success(request, "نسخه با موفقیت اضافه شد")
    return redirect("doctor:appointment_detail", appointment.appointment_id)
...
def mark_noti_seen(request, id):
    ...
    messages.success(request, "اعلان به عنوان دیده شده علامت‌گذاری شد")
